async function saveToLocalStorage(event) {
  ...
  try {
    ...
    let res = await axios.post(
      "https://crudcrud.com/api/413446afaf6246c291fc09456534d045/appointmentData",
      obj
    );
    if (res.status === 201) {
...
async function editUser(userId, experience, description, category) {
  try {
    ...
    let response = await axios.put(
      `https://crudcrud.com/api/413446afaf6246c291fc09456534d045/appointmentData/${userId}`,
      obj
    );
...
async function deleteUser(obj) {
  try {
    let res = await axios.delete(
      `https://crudcrud.com/api/413446afaf6246c291fc09456534d045/appointmentData/${obj}`
    );
    //console.log(obj)
    if (res.status === 200) {
